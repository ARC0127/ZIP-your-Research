...
This pack preserves the original legacy modules verbatim and exposes **MASTER_v1.6.6.md** as the current copy/paste entrypoint.

## How to use (copy/paste)
1) Run `python tools/zyr.py build` to generate `skills/writing_engine/MASTER_v1.6.6.md`.
2) Copy `MASTER_v1.6.6.md` into your prompt or system instructions.

## Contents
- `modules/` — original legacy modules (legacy) (verbatim, unchanged)
- `legacy/` — legacy single-file prompts (verbatim)
- `MASTER_v1.6.6.md` — current generated aggregate prompt
- `MASTER_v1.3.2.md` — retained compatibility snapshot

## v1.3.2.1 Addendum (incremental; nothing removed)

- **MASTER_v1.3.2.md remains included** as a compatibility snapshot; use `MASTER_v1.6.6.md` for the current suite.
...
- Fast path: open `MASTER_v1.6.6.md` and paste it into a new ChatGPT conversation as your "system" or "instructions" prompt.
