---
id: S311
name: statistical_significance_sanity
...
outputs_required:
- What to test (effect size)
- CI / bootstrap plan
- Seed policy and power considerations
- How to report without p-hacking
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
# S311 Statistical Significance Sanity
...
1) What to test (effect size)
2) CI / bootstrap plan
3) Seed policy and power considerations
4) How to report without p-hacking
