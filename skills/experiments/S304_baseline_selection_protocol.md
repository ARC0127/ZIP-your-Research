---
id: S304
name: baseline_selection_protocol
...
outputs_required:
- Baseline universe (must-include / nice-to-have)
- Fair comparison protocol (data, compute, tuning)
- Failure cases where baseline is invalid
...
# S304 Baseline Selection Protocol
...
1) Baseline universe (must-include / nice-to-have)
2) Fair comparison protocol (data, compute, tuning)
3) Failure cases where baseline is invalid
4) Reporting table template
