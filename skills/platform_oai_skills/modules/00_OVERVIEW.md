...
1) The **platform runtime** provides convenience tooling and strict QA expectations under `/home/oai/skills/**`.
...
- Only the platform skill pack under `/home/oai/skills/**` is in scope.
