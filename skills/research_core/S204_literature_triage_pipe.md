---
id: S204
name: literature_triage_pipeline
...
outputs_required:
- Triage criteria (what to read/skip)
- A 2-pass reading workflow (15min scan + deep read)
- Notes template aligned to claims/evidence
- A Action list list for missing citations
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
# S204 Literature Triage Pipeline
...
1) Triage criteria (what to read/skip)
2) A 2-pass reading workflow (15min scan + deep read)
3) Notes template aligned to claims/evidence
4) A Action list list for missing citations
