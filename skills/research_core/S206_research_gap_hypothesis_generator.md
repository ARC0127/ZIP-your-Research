---
id: S206
name: research_gap_hypothesis_generator
...
outputs_required:
- Top 5 candidate gaps (with assumptions)
- 1–2 falsifiable hypotheses per gap
- Minimal evidence needed for each hypothesis
- 2-hour validation plan for the top hypothesis
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
# S206 Research Gap Hypothesis Generator
...
1) Top 5 candidate gaps (with assumptions)
2) 1–2 falsifiable hypotheses per gap
3) Minimal evidence needed for each hypothesis
4) 2-hour validation plan for the top hypothesis
