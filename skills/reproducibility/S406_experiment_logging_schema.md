...
outputs_required:
- Canonical run config schema (YAML/JSON)
- Required metrics and artifacts
- Directory structure
- Minimal reproducible 'run package'
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
# S406 Experiment Logging Schema
...
1) Canonical run config schema (YAML/JSON)
2) Required metrics and artifacts
3) Directory structure
4) Minimal reproducible 'run package'
