...
outputs_required:
- Environment capture checklist (OS/GPU/driver)
- Dependency pinning strategy
- Rebuild instructions (step-by-step)
...
1) Environment capture checklist (OS/GPU/driver)
2) Dependency pinning strategy
3) Rebuild instructions (step-by-step)
