...
This module vendors a **portable, ZYR-aligned rewrite** of the platform runtime skill pack found under `zyr_runtime_skills/**`.
...
- Full 28-file rewrite set (mirrors `zyr_runtime_skills/**` 1:1):
