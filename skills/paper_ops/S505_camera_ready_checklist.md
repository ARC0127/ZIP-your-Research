...
inputs_required:
- venue/context
- paper snapshot (title/abstract or section)
- review comments (if any)
- constraints (length/time)
outputs_required:
- Blocking checklist (format/policy)
- Content checklist (claims/figures)
- Repro artifacts checklist
- Final submission rehearsal steps
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
1) Blocking checklist (format/policy)
2) Content checklist (claims/figures)
3) Repro artifacts checklist
4) Final submission rehearsal steps
