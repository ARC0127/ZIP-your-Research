...
outputs_required:
- 1-paragraph pitch
- Fit-to-venue bullets
- Novelty & significance bullets
- Disclosure/ethics statements if needed
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
1) 1-paragraph pitch
2) Fit-to-venue bullets
3) Novelty & significance bullets
4) Disclosure/ethics statements if needed
