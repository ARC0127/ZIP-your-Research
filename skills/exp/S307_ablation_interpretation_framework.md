---
id: S307
name: ablation_interpretation_framework
...
- acceptance criteria
- expected signals (support/refute)
- failure modes & debug order
- minimal logging spec
quality_gates:
- no fabrication
- mark UNKNOWN
- decision-oriented
...
# S307 Ablation Interpretation Framework
...
1) experiment plan (step-by-step)
2) acceptance criteria
3) expected signals (support/refute)
4) failure modes & debug order
5) minimal logging spec
