...
outputs_required:
- Error taxonomy
- Sampling plan for failure cases
- Diagnostic plots/tables to generate
...
1) Error taxonomy
2) Sampling plan for failure cases
3) Diagnostic plots/tables to generate
4) Actionable fixes ranked by expected impact
