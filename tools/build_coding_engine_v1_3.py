...
def main():
    ...
    parts.append("> **Normative rules:** `skills/reproducibility/S430_debug_vibe_core.md` + `boot/10_LOCKED_SCOPE_GUARD_v1.3.md` + `boot/11_COMPLETION_FIRST_ANTI_SHORTCUT_v1.5.md`.\n\n---\n")
    for p in modules:
