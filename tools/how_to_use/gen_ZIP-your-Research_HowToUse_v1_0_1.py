#!/usr/bin/env python3
"""
Generate the English-only "How to Use" PDF for ZIP-your-Research (v1.0.1).

This document is aligned to the current v1.0.1 release zip layout:
...
Usage:
  ...
  python3 tools/how_to_use/gen_ZIP-your-Research_HowToUse_v1_0_1.py

Output:
  ZIP-your-Research_How_to_Use_v1.0.1.pdf
"""
...
VERSION_TIME = "2026-02-03"
OUT_PDF = "ZIP-your-Research_How_to_Use_v1.0.1.pdf"
...
RELEASE_ZIP_NAME = "ZIP-your-Research_v1.0.1_release.zip"
UNZIP_PARENT = "ASR"
...
def build_sections(styles):
    ...
    # 0) What’s inside + defaults (aligned with the v1.0.1 release zip)
    sections.append(Section(
        ...
        blocks=[
            ...
            Block("bullets", [
                ...
                "How-to-use PDF: docs/how_to_use/ZIP-your-Research_How_to_Use_v1.0.1.pdf",
            ]),
    ...
    sections.append(Section(
        ...
        blocks=[
            ...
            Block("bullets", [
                ...
                "Reference: boot/02_PRELOCK_VIOLATION_RESPONSE_v1.0.1.md",
            ]),
    ...
    sections.append(Section(
        ...
        blocks=[
            ...
            Block("p", "v1.0.1 includes a conservative skeleton generator. It does not infer commands automatically; you fill in the missing details without fabrication."),
            Block("code",
