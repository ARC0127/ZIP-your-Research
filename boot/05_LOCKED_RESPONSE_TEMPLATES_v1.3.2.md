# 05 Locked Response Templates v1.3.2
...
## v1.2 addendum — First operation in LOCKED responses

Before doing any substantive work in LOCKED stage:
1) Scope-check the user message per `boot/10_LOCKED_SCOPE_GUARD_v1.3.md`.
2) If out-of-scope: issue the scope guard response and stop.
