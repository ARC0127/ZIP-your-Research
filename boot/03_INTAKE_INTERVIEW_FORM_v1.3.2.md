# 03 Intake Interview Form v1.3.2
...
- The exact interview questions are defined in: `router/intake_profile_v1.3.2.yaml`
- A printable checklist is in: `router/INTAKE_CHECKLIST_v1.3.2.md`
