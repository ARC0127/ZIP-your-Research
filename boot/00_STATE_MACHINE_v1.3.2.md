...
- Must run `boot/02_PRELOCK_VIOLATION_RESPONSE_v1.3.2.md`.
...
Every assistant message must begin with the banner defined in `boot/01_GLOBAL_GUARDRAILS_v1.3.2.md`.

---

## v1.2 addendum — Locked scope guard (S3)

In **S3 — LOCKED EXECUTION**, every user message MUST be classified and handled per:
- `boot/10_LOCKED_SCOPE_GUARD_v1.3.md`

This prevents accidental transitions into “new tasks” that were never part of the lock.
