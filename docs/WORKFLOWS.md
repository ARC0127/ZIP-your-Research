...
6) Use **writing_engine (MASTER_v1.6.6.md)** to convert the outcome into a paper-ready paragraph.
...
5) `python tools/make_release_v1_7.py --out ZIP-your-Research_release.zip`: produce a clean, audited zip without `.git`.
